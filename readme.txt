...
re re re 2:
странно, вы читали только дескриптор описания?
там черным по белому написана интсрукция
Wait_On_Following_Loads_And_Stores_Until(preceding_loads_and_stores_globally_visible);
ключевое слово wait. Может быть я неудачно выразился насчет стухания кэша, просто и результат и действия одинаковы
фактически mfence - программное "стухание кэша", которое и обеспечивает
